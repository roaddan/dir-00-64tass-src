...
helptext        .text   format(" spritechar  : SYS%5d",spritechar)
                .byte   $0d
                .text   format(" Scroll 1 pixel down: SYS%5d",spritechar)
                .byte   $0d
                .text   format(" ex.: SYS%5d",spritechar)
                .byte   $0d
                .text   format("      for i=0to100:SYS%5d:next",spritechar)
                .byte   $0d,0
                .bend
;*=$4000

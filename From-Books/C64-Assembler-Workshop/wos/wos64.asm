...
msg1            .byte 1         
                .text " ************************************  "
                .byte 13, 0     
msg2            .byte 1    ; clear+home, cr
                .text " *** c64 super basic etendue v1.1 ***  "
                .byte 13,0      ; cr, eot  
msg3            .byte 1         
                .text " ******* par daniel lafrance. *******  "
                .byte 13, 0     
msg4            .byte 1
                .text " ****** compiled on 2019-12-06 ******  "
                .byte 13,0

initwos         nop
                lda #<msg0      ; 110 - 2 charge lsb du message initial
                ldy #>msg0      ; 120 - 2 charge msb du message initial 
                jsr outs        ; 130 - 3 affiche le message initial (basic)
...
cls             lda #$93        ; code 147 clear+home
                jmp $ffd2       ; 
low             lda #$0e
                jmp $ffd2
up              lda #$8d

...
outbytec         sta     outbytec_ra      ; ... A, ...
                ...
                sta     outbytec_zl      ; ... SEROPAGE et ... 
                lda     ZEROPAGE+1      ; ... et celui ...        
                sta     outbytec_zh      ; ... du MSB.
                lda     CARCOL          ; On sauvegarde localement le registre   
                sta     outbytec_carcol  ; ... de couleur du caractère de BASIC
;-------------------------------------------------------------------------------
...
;-------------------------------------------------------------------------------
                ...
                ;lda     outbytec_ra    ; Si a contenait un param d'entrée alors! 
;-------------------------------------------------------------------------------
...
;-------------------------------------------------------------------------------
outbytec_out    ;pha                     ; Si A contient un paramètre de retour.
...
;-------------------------------------------------------------------------------
                lda     outbytec_carcol  ; On redonne à BASIC sa couleur.
                sta     CARCOL
                lda     outbytec_zl      ; et on récupère les registres que nous                
                ...
                rts                     
;-------------------------------------------------------------------------------
outbytec_ra     .byte   0               ; Ces lignes constitues un pseudo stack. 
outbytec_rx     .byte   0               ; Même su cette méthode est couteuse en 
outbytec_ry     .byte   0               ; Voici
outbytec_sf     .byte   0               ; Le stack du 6502 étant limité à une 
outbytec_zl     .byte   0               ; seule page de 256 octets et qu'il est
outbytec_zh     .byte   0               ; largement utilisé par Basic, la méthode
outbytec_carcol .byte   0               ; de parametre inline inline est utile.
outbytec_turbo  .byte   1               ; Si nous en avions besoin de plus de 
                                        ; nous pourrions les 
                                        ; créer ici. 
;-------------------------------------------------------------------------------               

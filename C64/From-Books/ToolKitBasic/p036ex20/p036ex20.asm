...
shortcuts .byte     b_blue,b_space,b_rvs_on
          ...
          .text     format(   " p036ex20: SYS %d ($%04X)",p036ex20, p036ex20)
          .byte     b_crlf
...
aidetext  .byte     b_crlf,b_space,b_red
          .text     format(   " ex.: SYS %d",p036ex20)
;          .byte     b_crlf
;          .text     format(   "      for i=0to100:SYS%05d:next",p036ex20)

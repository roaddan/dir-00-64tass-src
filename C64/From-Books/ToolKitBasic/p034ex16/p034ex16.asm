...
again     #v20col
          ...
          lda  #$05
noneg     jsr  b_f1pacc       ; Converti le résultat en ascii à $0100.
          jsr  b_facasc
          #print restxt1
...
ttext     .byte     b_blue,b_space,b_rvs_on
          .text     "  P.F. - FAC1 = FAC1+ACCUM (Accum=5)  "
...
shortcuts .byte     b_blue,b_space,b_rvs_on
          ...
          .text     format(   " p034ex16: SYS %d ($%04X)",p034ex16, p034ex16)
          .byte     b_crlf
...
aidetext  .byte     b_crlf,b_space,b_red
          .text     format(   " ex.: SYS %d",p034ex16)
;          .byte     b_crlf
;          .text     format(   "      for i=0to100:SYS%05d:next",p034ex16)

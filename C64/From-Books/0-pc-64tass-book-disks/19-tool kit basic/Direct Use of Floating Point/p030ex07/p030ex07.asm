...
ttext     .byte     b_blue,b_space,b_rvs_on
          .text     " MULTIPLICATION x 10 - POINT FLOTTANT "
...
shortcuts .byte     b_blue,b_space,b_rvs_on
          ...
          .text     format(   " p030ex07: SYS %d ($%04X)",p030ex07, p030ex07)
          .byte     b_crlf
...
helptext  .byte     b_crlf,b_space,b_red
          .text     format(   " ex.: SYS %d",p030ex07)
;          .byte     b_crlf
;          .text     format(   "      for i=0to100:SYS%05d:next",p030ex07)

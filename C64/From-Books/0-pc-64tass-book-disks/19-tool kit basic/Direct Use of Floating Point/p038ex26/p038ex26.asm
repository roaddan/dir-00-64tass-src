...
ttext     .byte     b_white,b_space,b_blue,b_rvs_on
          .text      "     ($aaXX) a point flottant FAC1    "
...
shortcuts .byte     b_blue,b_space,b_rvs_on
          ...
          .text     format(   " p038ex26: SYS %d ($%04x)",p038ex26, p038ex26)
          .byte     b_crlf
...
aidetext  .byte     b_crlf,b_space,b_red
          .text     format(   " ex.: SYS %d",p038ex26)
;          .byte     b_crlf
;          .text     format(   "      for i=0to100:SYS%05d:next",p038ex26)

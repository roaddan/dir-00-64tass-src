...
;-------------------------------------------------------------------------------
titre       .byte 1,2,3,4,5,6,7,8,9,0
...
mcpy_start  lda #<mcpy_src
            ...
            beq mcpy_rem
            ldy #$ff
mcpy_next   lda (mcpy_zp1),y        
            sta (mcpy_zp2),y
            dey
            cpy #$ff
            bne mcpy_next
mcpy_nxblk  inc mcpy_zp1+1
            inc mcpy_zp2+1
            dex
            bmi mcpy_end
            bne mcpy_next
...
mcpy_dst    .word $0
mcpy_len    .word $0
mcpy_zp1 = ZEROPAGE  ; from
mcpy_zp2 = ZONEPAGE  ; to
;-------------------------------------------------------------------------------
